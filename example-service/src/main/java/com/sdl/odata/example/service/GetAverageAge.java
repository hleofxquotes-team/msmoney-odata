...
public class GetAverageAge implements Operation<Double> {
    ...
    public Double doOperation(ODataRequestContext oDataRequestContext, DataSourceFactory dataSourceFactory) throws ODataException
    {
        ...
        InMemoryDataSource<Person> dataSource = (InMemoryDataSource<Person>) dataSourceFactory.getDataSource(oDataRequestContext,
                "SDL.OData.Example.Person");
        ConcurrentMap<String, Person> personConcurrentMap = dataSource.getConcurrentMap();
